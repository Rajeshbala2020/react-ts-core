...
const ModernAutoCompleteDropdown: React.FC<AutoSuggestionInputProps> = ({
  ...
  const handleScroll = (event: any) => {
    ...
    // Don't close if the user is scrolling inside the main autocomplete container
    // or inside the dropdown content itself (portal list).
    if (
      scrollTarget &&
...
export default ModernAutoCompleteDropdown;
